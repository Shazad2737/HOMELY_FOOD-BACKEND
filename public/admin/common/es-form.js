document.addEventListener('DOMContentLoaded', function () {
    // Notification helper functions (uses sweet-alert-actions.js)
    ...
    document.body.addEventListener('submit', function (e) {
        // Check if the submitted form matches your criteria (e.g., has the class .es-form)
        if (e.target.classList.contains('es-form')) {
            e.preventDefault()

            var sourceForm = e.target
